export const translateFr = {
  ...
  buttonConf: "Configurateur",
  buttonProy: "Nos projets",
  ...
  contentTextBen4: "Finitions parfaites",
  contentTextBen5: "Utilisation optimale et rationnelle de chaque espace",
  contentTextBen6: "Isolation thermique et acoustique",
  contentTextBen7: "Fiabilité",
  contentTextBen8: "Confort",
  contentTextBen9: "Économie d'énergie",
  contentTextBen10: "Solutions testées et approuvées en interne",
  ...
  textButtonSanitario3: "Sanitaire Type 3",
  textButtonSanitario4: "Sanitaire Type 4",
  textButtonSanitario5: "Sanitaire Type 5",
  textTittleDescripcion: "Description",
  textTittleCaracteristicas: "Caractéristiques Techniques",
  textLongitud: "Longueur",
  textAncho: "Largeur",
  textAlturaTotal: "Hauteur Totale",
  textAltura: "Hauteur",
  textPeso: "Poids",
  textEstructura: "Structure",
  textPaneles: "Panneaux",
  textSuelo: "Sol",
  textPuertas: "Portes",
  textVentanas: "Fenêtres",
  textElectricidad: "Électricité",
  textOtros: "Autres Composants",
  ...
  textSuelosGeneral:
    "Plancher contreplaqué hydrofuge, revêtement de sol en PVC Gerflex",
  textPuertasGarita1: "1 Porte en aluminium de 70 x 200 cm",
  textVentanasGarita1: "1 Fenêtre en aluminium de 100 x 100 cm",
  textElectricidadGeneral:
    "Installation électrique complète : coffre-fort, 4 prises de courant, 1 bandeau Led de 120,01 double interrupteur marche/arrêt et globe étanche extérieur et intérieur.",
  textOtrosGeneral: "Crochets de levage à chaque extrémité du toit",
  textVentanasGarita2: "2 Fenêtres en aluminium de 100 x 100 cm",
...
`,
  ...
  //Nosotros
  tittleTextNosotros: "QUI SOMME-NOUS",
  textNosotros:
    "Entreprise spécialisée dans la construction, préfabriquée, métallique et modulaire, Basée à Abidjan en Côte d'Ivoire, GSP a été fondée en 2020 lors de la crise de la COVID-19 pour répondre au besoin croissant de bâtiments préfabriqués sur le marché. <br /> <br /> Depuis lors, nous avons réalisé avec succès plus de 3500m2 de modules, bungalows et bâtiments préfabriqués, entièrement personnalisés et sur mesure, pour les plus grandes entreprises de BTP et Génie civil en Afrique. <br /> <br /> Nous avons réalisé plus de 75 projets dans divers secteurs d'activités tels que des installations de chantiers pour les constructeurs, des extensions de bureaux, des boutiques et des points de vente pour les particuliers, les ONG, les organismes internationaux et d'autres institutions ivoiriennes. <br /> <br /> Nous avons également réalisé des hangars de stockage d'agrégats, des entrepôts industriels et des charpentes métalliques pour les grands projets de développement de la Côte d'Ivoire tels que la Tour F en cours de réalisation, le Parc d'Exposition de l'Aéroport PHB, l'échangeur du grand Rond-point d'Abobo, l'Esplanade du Palais Présidentiel, etc.",
  tittleTextVision: "Notre Vision",
  textVision:
  ...
  tittleTextFormContact: "Formulaire de <br /> Contact",
  textContactNombre: "Nom",
  textContactApellido: "Prénom",
  textContactEmail: "Email",
  textContactTelefono: "Téléphone",
  textContactMensaje: "Description",
  textContactPolicity:
  ...
  textContactFoto: "AUCUNE PHOTO SÉLECTIONNÉE",
