...
export default function DashboardUsuarios() {
  ...
  useEffect(() => {
    async function fetchCount() {
      const response = await fetch(
        "https://globalsolutionsprefabriquees.com/api/user/users"
      );
  ...
  function handleDeleteUser(e, id) {
    e.preventDefault();
    fetch(`https://globalsolutionsprefabriquees.com/api/user/delete/${id}`, {
      method: "PATCH",
      headers: {
  ...
  function activeUser(e, idUser) {
    ...
    fetch(`https://globalsolutionsprefabriquees.com/api/user/${idUser}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
